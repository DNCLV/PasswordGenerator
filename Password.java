...
public class Password {
	...
	public String generator() {
		if (isUppercase)
			sb.append(uppercasePart);
		if (isLowercase)
			sb.append(lowercasePart);
		if (isNumber)
			sb.append(numberPart);
		if (isSymbol)
			sb.append(symbolPart);
		if (isLowercase)
			sb.append(appendRemainder);
		return sb.toString();
	}
	...
	// Method to recap criteries for password

	public void pwInfo() {
		System.out.println("You have chosen the following preferences for your password: ");
		System.out.println("Desired Password Length: " + passwordLength + " characters");
		if (isUppercase == true) {
			System.out.println("Use Uppercase: Yes");
		} else {
			System.out.println("Use Uppercase: No");
		}
		if (isNumber == true) {
			System.out.println("Use Numbers: Yes");
		} else {
			System.out.println("Use Numbers: No");
		}
		if (isSymbol == true) {
			System.out.println("Use Symbols: Yes");
		} else {
			System.out.println("Use Symbols: No");
		}
	}
